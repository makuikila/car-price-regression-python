...
On a 70/30 train/test split, all three models perform similarly, with Ridge edging out slightly thanks to its regularization:

| Model | R² | RMSE |
|---|---|---|
| Linear Regression | 0.832 | 3,184 $ |
| **Ridge Regression** | **0.835** | **3,159 $** |
| Lasso Regression | 0.832 | 3,180 $ |

![Model comparison](assets/model_comparison.png)

Predicted vs. actual prices for the best model (Ridge) — most points fall close to the diagonal, with the model slightly underestimating the most expensive cars:

![Predicted vs actual](assets/predicted_vs_actual.png)

Residual analysis confirms no strong systematic bias, though variance increases for higher-priced cars (heteroscedasticity), a common pattern in price-prediction tasks:
